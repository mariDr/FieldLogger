...
/**
 * a fragment to display details of HP1
 * 
 */
public class FragHp1 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.fragment_hp1, container, false);
		return rootView;
	}
	...
	public void onStart() {
		...
		logAdapter = new DbOperations(getActivity(), "hp1");
		logAdapter.createDB();
		logAdapter.openDB();
		logAdapter.close();
	}
